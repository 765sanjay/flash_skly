                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image.asset(
                              ...
                              width: 32,
                              fit: BoxFit.cover,
                              errorBuilder: (context, error, stackTrace) => Icon(Icons.image, size: 32, color: Colors.grey),
                            ),
                          ),
                          SizedBox(height: 4),
                          Text(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          product['image'],
                          width: double.infinity,
                          height: constraints.maxWidth * 0.8, // Dynamic height
                          fit: BoxFit.cover,
                        ),
                      ),
                      // Discount Badge
